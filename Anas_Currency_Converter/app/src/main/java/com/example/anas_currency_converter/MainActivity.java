                        ...
                        convert_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (getMoney.isEmpty()) {
                                    ...
                                    Double store = Double.parseDouble(new DecimalFormat("##.####").format(converttodouble_et * 278.54));
                        ...
                        convert_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (getMoney.isEmpty()) {
                                    ...
                                    Double converttodouble_et = Double.parseDouble(getMoney);
                                    Double store = Double.parseDouble(new DecimalFormat("##.####").format(converttodouble_et * 0.91));
                                    rupees.setText("" + store);
                                }
                            }
                        });
                        ...
                        convert_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (getMoney.isEmpty()) {
                                    ...
                                    Double converttodouble_et = Double.parseDouble(getMoney);
                                    Double store = Double.parseDouble(new DecimalFormat("##.####").format(converttodouble_et * 0.77));
                                    rupees.setText("" + store);
                                }
                            }
                        });
                        ...
                        convert_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (getMoney.isEmpty()) {
                                    ...
                                    Double converttodouble_et = Double.parseDouble(getMoney);
                                    Double store = Double.parseDouble(new DecimalFormat("##.####").format(converttodouble_et * 33.69));
                                    rupees.setText("" + store);
                                }
                            }
                        });
                        ...
                        convert_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (getMoney.isEmpty()) {
                                    ...
                                    Double converttodouble_et = Double.parseDouble(getMoney);
                                    Double store = Double.parseDouble(new DecimalFormat("##.####").format(converttodouble_et * 1.37));
                                    rupees.setText("" + store);
                                }
                            }
                        });
                        ...
                        convert_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (getMoney.isEmpty()) {
                                    ...
                                    Double converttodouble_et = Double.parseDouble(getMoney);
                                    Double store = Double.parseDouble(new DecimalFormat("##.####").format(converttodouble_et * 1.50));
                                    rupees.setText("" + store);
                                }
                            }
                        });
                        ...
                        convert_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (getMoney.isEmpty()) {
                                    ...
                                    Double converttodouble_et = Double.parseDouble(getMoney);
                                    Double store = Double.parseDouble(new DecimalFormat("##.####").format(converttodouble_et * 1.32));
                                    rupees.setText("" + store);
                                }
                            }
                        });
                        ...
                        convert_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (getMoney.isEmpty()) {
                                    ...
                                    Double converttodouble_et = Double.parseDouble(getMoney);
                                    Double store = Double.parseDouble(new DecimalFormat("##.####").format(converttodouble_et * 134.33));
                                    rupees.setText("" + store);
                                }
                            }
                        });
